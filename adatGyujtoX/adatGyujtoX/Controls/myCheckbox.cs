...
{
    public class myCheckbox : ContentView, IDisposable
    {
        #region Fields
        ...
        public static BindableProperty OutlineColorProperty = BindableProperty.Create(nameof(OutlineColor), typeof(Color), typeof(myCheckbox), Color.Blue);
        ...
        public static BindableProperty FillColorProperty = BindableProperty.Create(nameof(FillColor), typeof(Color), typeof(myCheckbox), Color.Blue);
        /// <summary>
        ...
        public static BindableProperty CheckColorProperty = BindableProperty.Create(nameof(CheckColor), typeof(Color), typeof(myCheckbox), Color.White);
        /// <summary>
        ...
        public static BindableProperty OutlineWidthProperty = BindableProperty.Create(nameof(OutlineWidth), typeof(float), typeof(myCheckbox), DEFAULT_OUTLINE_WIDTH);
        /// <summary>
        ...
        public static BindableProperty ShapeProperty = BindableProperty.Create(nameof(Shape), typeof(Shape), typeof(myCheckbox), DEFAULT_SHAPE);
        /// <summary>
        ...
        public static BindableProperty DesignProperty = BindableProperty.Create(nameof(Design), typeof(Design), typeof(myCheckbox), DEFAULT_DESIGN);
        /// <summary>
        /// Gets or sets the shape of the <see cref="T:IntelliAbb.Xamarin.Controls.Checkbox"/>.
        /// </summary>
        ...
        public static new BindableProperty StyleProperty = BindableProperty.Create(nameof(Style), typeof(Style), typeof(myCheckbox), propertyChanged: OnStyleChanged);
